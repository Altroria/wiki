...
(
  ...
  default char set = utf8mb4 comment ='测试';

insert into test (id, name, password)
VALUES (1, 'sunh', '123456');
...
(
    ...
    primary key (id)
) engine = innodb default char set = utf8mb4 comment ='电子书';
...
(
    ...
    sort int comment '顺序',
    primary key (id)
) engine = innodb default char set = utf8mb4 comment ='分类';
